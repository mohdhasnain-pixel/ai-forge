...
def set_auth_token(token: str) -> None:
    ...
    """
    from ai_forge_cli.utils.qr_url import validate_token
...
def create_app(host: str = "127.0.0.1", port: int = 7860):
    ...
    def system_info():
        ...
        from ai_forge_cli.utils.gpu import detect_device, get_gpu_info
    ...
    def start_training(req: TrainRequest):
        ...
        with _train_lock:
            ...
            _train_process = subprocess.Popen(
                [sys.executable, "-m", "ai_forge_cli", "train", "--config", config_path, "--yes"],
    ...
    async def stream_train_events():
        ...
        from ai_forge_cli.utils.sse_train_stream import TrainEvent, format_sse_frame
        from ai_forge_cli.utils.train_event_buffer import get_global_buffer
    ...
    def list_tool_outputs(
        ...
        """
        from ai_forge_cli.utils.tool_outputs import get_global_tool_buffer
