...
:class:`~ai_forge_cli.trainer.sft.SFTTrainerWrapper` for model/tokenizer/LoRA/CE
...
Security / robustness:
- Family validated via :func:`ai_forge_cli.utils.tts.validate_tts_family` before
  any model load.
...
from ai_forge_cli.trainer.sft import SFTTrainerWrapper, console
