...
class PreferenceTrainerWrapper:
    ...
    def _build_multi_objective(self):
        ...
        The math kernel ships in :mod:`ai_forge_cli.utils.preference_combine`
        ...
        if primary == "dpo":
            from ai_forge_cli.trainer.dpo import DPOTrainerWrapper as PrimaryWrapper
        elif primary == "simpo":
            from ai_forge_cli.trainer.simpo import SimPOTrainerWrapper as PrimaryWrapper
        elif primary == "orpo":
            from ai_forge_cli.trainer.orpo import ORPOTrainerWrapper as PrimaryWrapper
        elif primary == "ipo":
            from ai_forge_cli.trainer.ipo import IPOTrainerWrapper as PrimaryWrapper
        elif primary == "bco":
            from ai_forge_cli.trainer.bco import BCOTrainerWrapper as PrimaryWrapper
    ...
    def setup(self, dataset: dict) -> None:
        ...
        if is_multi_objective_preference(self.config):
            ...
            from ai_forge_cli.utils.preference_combine import validate_weight_compat
