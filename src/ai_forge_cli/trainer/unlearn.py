...
optimises the per-method loss from :mod:`ai_forge_cli.utils.unlearn_kernels`.
...
class UnlearnTrainerWrapper:
    ...
    def setup(self, dataset: Any = None) -> None:
        ...
        from ai_forge_cli.utils.live_eval import load_model_and_tokenizer
    ...
    def train(self, **kwargs: Any) -> dict:
        ...
        from ai_forge_cli.utils.live_eval import _tokenize_pair
    ...
    def _step_preference(self, tokenize_pair, prompt, target, method, dev):
        ...
        from ai_forge_cli.utils.unlearn_kernels import (
            npo_loss,
            sequence_lengths,
            sequence_logprob,
            simnpo_loss,
