...
a subprocess via ``subprocess.Popen([sys.executable, "-m", "ai_forge_cli.cli",
...
from ai_forge_cli.utils.canary_router import BucketStats, CanaryPolicy, rollback
...
from ai_forge_cli.utils.loop_state import LoopState, read_state, write_state
...
def default_harvest(state: LoopState) -> Mapping[str, object]:
    ...
    Real implementation wires v0.26.0 ``ai_forge_cli.data.traces.parsers`` +
