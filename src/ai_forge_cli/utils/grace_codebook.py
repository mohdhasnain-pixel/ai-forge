...
if TYPE_CHECKING:  # pragma: no cover — type-only imports
    ...
    from ai_forge_cli.utils.knowledge_edit import EditPlan, EditResult
...
def apply_grace_edit(
    ...
    *,
    ...
    from ai_forge_cli.utils.edit_kernels import _locate_decoder_layers, measure_target_prob
