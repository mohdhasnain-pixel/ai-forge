...
def apply_pre_lora_patches(model: Any, base: str) -> None:
    ...
    """
    from ai_forge_cli.utils.peft_patches import apply_gemma4_clippable_patch, is_gemma4_model
...
def rl_callbacks_need_buffer(tcfg: Any) -> bool:
    ...
    :class:`~ai_forge_cli.utils.rl_signal_buffer.RLSignalBuffer`. The
...
def attach_plugin_callback(trainer: Any, console: Any = None) -> bool:
    ...
    if console is not None:
        try:
            ...
            from ai_forge_cli.plugins import list_plugins
