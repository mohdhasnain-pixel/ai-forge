...
deceptive ones. Built on the shared :mod:`ai_forge_cli.utils.probe_kernel`: the real
...
from ai_forge_cli.utils.probe_kernel import (  # noqa: F401 — re-exported for #217
    PROBE_VERDICTS,
    ProbeResult,
    ProbeSpec,
    apply_linear_probe,
