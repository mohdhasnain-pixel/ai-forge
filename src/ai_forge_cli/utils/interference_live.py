...
The v0.66.0 :mod:`ai_forge_cli.utils.interference` matrix builder consumes a dict of
...
and in :mod:`ai_forge_cli.utils.live_eval`; importing this module is cheap.
...
from ai_forge_cli.utils.interference import _MAX_ADAPTERS, _MIN_ADAPTERS
...
def measure_interference_losses(
    ...
    *,
    ...
    :func:`ai_forge_cli.utils.interference.build_interference_matrix`.
    """
