...
_TRAIN_FIX = "Training needs the \\[train] extra. Run: pip install \"ai-forge\\[train]\""
...
ERROR_MAP = [
    ...
    (
        ...
        "Run: pip install \"ai-forge\\[serve]\"",
    ),
    (
    ...
    (
        ...
        "Run: pip install \"ai-forge\\[deepspeed]\"",
    ),
    (
        "No module named 'httpx'",
        "httpx is not installed (needed for data generate).",
        "Run: pip install \"ai-forge\\[generate]\"",
    ),
