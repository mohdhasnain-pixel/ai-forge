...
def validate_quant_shape(key: str, spec: Any, shard_spec: Mapping[str, Any]) -> None:
    ...
    """
    from ai_forge_cli.utils.layer_shard import ABSMAX_SUFFIX, NESTED_ABSMAX_SUFFIX
...
def _dtype_size(name: str) -> int:
    from ai_forge_cli.utils.layer_stream import dtype_bytes
...
def measure_step_peak_bytes(
    ...
    *,
    ...
    :func:`~ai_forge_cli.utils.layer_stream.measure_logits_loss_bytes_per_element`
    already keeps.
    """
    if not str(device).startswith("cuda"):
        return None
...
def build_meta_skeleton(
    ...
    *,
    ...
    from ai_forge_cli.utils.layer_shard import QUANT_NF4, SUPPORTED_STREAM_QUANTS
...
def install_streaming(
    ...
    *,
    ...
    from ai_forge_cli.utils.layer_shard import QUANT_NF4
