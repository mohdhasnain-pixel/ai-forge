...
- Part C (``ai_forge_cli.utils.sleeper_probe``) — the live sleeper probe
- Part A (``ai_forge_cli.utils.sae_diff``) — the SAE feature-diff surface
- Part D (``ai_forge_cli.utils.interference``) — adapter pairwise eval
...
def _make_bundled_packs() -> Mapping[str, ProbePack]:
    ...
    from ai_forge_cli.utils.harm_probe import BUNDLED_HARM_PROBES
    from ai_forge_cli.utils.sleeper_probe import BUNDLED_PROBES
    from ai_forge_cli.utils.truth_probe import BUNDLED_TRUTH_PROBES
