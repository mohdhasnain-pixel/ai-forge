...
:mod:`ai_forge_cli.mcp_server.registry` (no SDK dependency, fully unit-testable).
"""
...
from ai_forge_cli.mcp_server.execution import ExecutionManager
from ai_forge_cli.mcp_server.registry import McpToolError, ToolSpec, _sanitize, build_registry
