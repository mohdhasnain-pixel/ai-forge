...
training:
  ...
  rollout_func: ai_forge_cli.envs.calculator:rollout
...
training:
  ...
  reward_fn: accuracy
  rollout_backend: openenv
  rollout_func: ai_forge_cli.envs.retrieval_qa:rollout
...
training:
  ...
  verifiable_domain: math
  rollout_backend: openenv
  rollout_func: ai_forge_cli.envs.guess_number:rollout
