...
class SoupTrainerCallback(TrainerCallback):
    ...
    def on_log(
        ...
        try:
            ...
            from ai_forge_cli.utils.train_event_buffer import push_train_event
    ...
    def _build_gate_generate_fn(self, model: object, tokenizer: object):
        ...
        """
        from ai_forge_cli.utils.live_eval import make_generator
    ...
    def _run_eval_gate(self, state: TrainerState, control: TrainerControl) -> None:
        ...
        from ai_forge_cli.eval.gate import run_gate as _default_run_gate
    ...
    def _run_auto_eval(self) -> None:
        ...
        if benchmarks:
            try:
                from ai_forge_cli.commands.eval import benchmark
                benchmark(
