...
# POSIX: no-op.
from ai_forge_cli.utils.encoding import force_utf8_stdio
...
from ai_forge_cli import __version__  # noqa: E402
from ai_forge_cli.commands import (  # noqa: E402
    adapters,
    autopilot,
    bench,
    can,
...
from ai_forge_cli.commands import doctor as doctor_cmd  # noqa: E402
from ai_forge_cli.commands import fetch as fetch_cmd  # noqa: E402
from ai_forge_cli.commands import llama as llama_cmd  # noqa: E402
from ai_forge_cli.commands import (  # noqa: E402
    merge_sharded_fsdp_weights as merge_sharded_fsdp_weights_cmd,
)
from ai_forge_cli.commands import monitor as monitor_cmd  # noqa: E402
from ai_forge_cli.commands import quantize as quantize_cmd  # noqa: E402
from ai_forge_cli.commands import quickstart as quickstart_cmd  # noqa: E402
from ai_forge_cli.commands import spectrum as spectrum_cmd  # noqa: E402
from ai_forge_cli.commands import (  # noqa: E402
    tui as tui_cmd,
)
from ai_forge_cli.commands import (  # noqa: E402
...
from ai_forge_cli.utils.constants import GITHUB_URL  # noqa: E402
...
from ai_forge_cli.commands import plugins as plugins_cmd  # noqa: E402
...
from ai_forge_cli.commands import agent as agent_cmd  # noqa: E402
...
from ai_forge_cli.commands import data_forge as _data_forge_cmd  # noqa: E402

data.app.command(name="forge")(_data_forge_cmd.forge)

# v0.47.0 Part B — Data Quality Moat.
from ai_forge_cli.commands import data_score as _data_score_cmd  # noqa: E402
...
from ai_forge_cli.commands import data_mix as _data_mix_cmd  # noqa: E402

data.app.command(name="mix")(_data_mix_cmd.mix)

# v0.53.9 #15 — BPE tokenizer training.
from ai_forge_cli.commands import tokenizer as _tokenizer_cmd  # noqa: E402
...
from ai_forge_cli.commands import advise as _advise_cmd  # noqa: E402
...
from ai_forge_cli.commands import diagnose as _diagnose_cmd  # noqa: E402
...
from ai_forge_cli.commands import ship as _ship_cmd  # noqa: E402
...
from ai_forge_cli.commands import loop as _loop_cmd  # noqa: E402
...
from ai_forge_cli.commands import attest as _attest_cmd  # noqa: E402
from ai_forge_cli.commands import audit_log as _audit_log_cmd  # noqa: E402
from ai_forge_cli.commands import bom as _bom_cmd  # noqa: E402
...
from ai_forge_cli.commands import airgap as _airgap_cmd  # noqa: E402

app.command(name="airgap-bundle")(_airgap_cmd.airgap_bundle)

# v0.61.0 — Unlearning & Knowledge Edit: `soup edit set / diff`.
from ai_forge_cli.commands import edit as _edit_cmd  # noqa: E402
...
from ai_forge_cli.commands import steer as _steer_cmd  # noqa: E402
...
from ai_forge_cli.commands import ingest as _ingest_cmd  # noqa: E402
...
from ai_forge_cli.commands import prune_prompt as _prune_prompt_cmd  # noqa: E402
...
from ai_forge_cli.commands import active_sample as _active_sample_cmd  # noqa: E402

data.app.command(name="active-sample")(_active_sample_cmd.active_sample)

# v0.63.0 Part D — mSPRT A/B harness.
from ai_forge_cli.commands import ab as _ab_cmd  # noqa: E402
...
from ai_forge_cli.commands import drift_alarm as _drift_alarm_cmd  # noqa: E402
...
from ai_forge_cli.commands import tunability as _tunability_cmd  # noqa: E402
...
from ai_forge_cli.commands import plan as _plan_cmd  # noqa: E402
...
from ai_forge_cli.commands.env import env_app as _env_app  # noqa: E402

app.add_typer(_env_app, name="env")

# v0.64.0 Part E — Shell completions.
from ai_forge_cli.commands import completions as _completions_cmd  # noqa: E402
...
from ai_forge_cli.commands import license_advisor as _license_advisor_cmd  # noqa: E402
...
# / probe pack.
from ai_forge_cli.commands import probe as _probe_cmd  # noqa: E402
...
from ai_forge_cli.commands import lock as _lock_cmd  # noqa: E402
...
from ai_forge_cli.commands import apple_adapter as _apple_cmd  # noqa: E402
from ai_forge_cli.commands import compile_cmd as _compile_cmd  # noqa: E402
from ai_forge_cli.commands import compile_tools as _compile_tools_cmd  # noqa: E402
from ai_forge_cli.commands import distill_prompt as _distill_prompt_cmd  # noqa: E402
from ai_forge_cli.commands import local_rl as _local_rl_cmd  # noqa: E402
...
from ai_forge_cli.commands import build as _build_cmd  # noqa: E402
...
from ai_forge_cli.commands import expect as _expect_cmd  # noqa: E402
...
from ai_forge_cli.commands import iterative_dpo as _iterative_dpo_cmd  # noqa: E402
...
from ai_forge_cli.commands import ra_dit as _ra_dit_cmd  # noqa: E402
...
# preference linter.
from ai_forge_cli.commands import data_doctor as _data_doctor_cmd  # noqa: E402
...
from ai_forge_cli.commands import data_topics as _data_topics_cmd  # noqa: E402

data.app.command(name="topics")(_data_topics_cmd.topics)

from ai_forge_cli.commands import data_canary as _data_canary_cmd  # noqa: E402
...
from ai_forge_cli.commands import mcp as _mcp_cmd  # noqa: E402
...
from ai_forge_cli.commands import shrink as _shrink_cmd  # noqa: E402
...
from ai_forge_cli.commands import draft as _draft_cmd  # noqa: E402
...
from ai_forge_cli.commands import reward as _reward_cmd  # noqa: E402
...
# When invoked via `python -m ai_forge_cli`, __main__.py calls run() directly.
