...
def push(
    ...
    from ai_forge_cli.utils.hf import resolve_endpoint, resolve_token, validate_repo_id
...
def generate_model_card_v2(
    ...
    sections = [
        ...
        f"# {model_name}",
        "",
        "Fine-tuned model uploaded with [Soup CLI](https://github.com/mohdhasnain-pixel/ai-forge).",
        "",
        "## Model Details",
        "",
        details_block,
    ...
    if not training_section:
        tail.extend(
            [
                ...
                "(https://github.com/mohdhasnain-pixel/ai-forge) "
