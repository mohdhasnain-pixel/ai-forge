...
from ai_forge_cli.utils.adapter_fuse import fuse_adapter_into as _fuse_adapter
from ai_forge_cli.utils.adapter_fuse import release_cuda as _release_cuda
