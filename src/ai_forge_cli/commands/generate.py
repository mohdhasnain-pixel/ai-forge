...
def _run_dedup_pipeline(path: Path) -> None:
    ...
    try:
        ...
        console.print(
            ...
            "Install: pip install \"ai-forge\\[data]\"[/]"
        )
...
def _generate_batch(
    ...
    if provider == "openai":
        ...
        from ai_forge_cli.data.providers.ollama import DEFAULT_OLLAMA_BASE, generate_ollama
        ...
        from ai_forge_cli.data.providers.vllm import DEFAULT_VLLM_BASE, generate_vllm
...
def _parse_json_array(content: str) -> list[dict]:
    ...
    Delegates to ai_forge_cli.data.providers._utils.parse_json_array to avoid
