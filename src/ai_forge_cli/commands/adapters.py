...
def merge(
    ...
    from ai_forge_cli.utils.adapter_merge import SUPPORTED_STRATEGIES, merge_adapters
...
def arithmetic(
    ...
    from ai_forge_cli.utils.adapter_arithmetic import (
        ArithmeticReport,
        _detect_lora_rank,
    ...
    from ai_forge_cli.utils.adapter_diff import load_adapter_weights
...
def checkout(
    ...
    from ai_forge_cli.utils.adapter_branch import load_branch, write_checkout
...
def list_branches_cmd():
    ...
    from ai_forge_cli.utils.adapter_branch import list_branches, load_branch
...
def scan(
    ...
    """
    from ai_forge_cli.utils.adapter_scan import render_report_text, scan_adapter
...
def adapter_bisect(
    ...
    """
    from ai_forge_cli.utils.adapter_bisect import build_bisect_plan, run_bisect
