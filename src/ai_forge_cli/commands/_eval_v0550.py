...
def register(app: typer.Typer, console: Console) -> None:
    ...
    def design_cmd(
        ...
        from ai_forge_cli.utils.advise import load_advise_dataset
    ...
    def lock_cmd(
        ...
        from ai_forge_cli.utils.eval_design import load_eval_design
        from ai_forge_cli.utils.eval_lock_coverage import lock_suite
    ...
    def coverage_cmd(
        ...
        from ai_forge_cli.utils.eval_design import load_eval_design
        from ai_forge_cli.utils.eval_lock_coverage import compute_coverage
    ...
    def against_cmd(
        ...
        # passed the gate.
        if suite:
            from ai_forge_cli.utils.eval_lock_coverage import load_locked_suite
    ...
    def gate_install_cmd(
        ...
        from ai_forge_cli.utils.eval_gate_hook import write_pre_push_hook
