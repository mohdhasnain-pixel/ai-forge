...
from ai_forge_cli.utils._eval_text import row_text
...
from ai_forge_cli.utils.topics import build_topic_report, kmeans, resolve_k

console = Console()


def _report_to_dict(report) -> dict:
    """JSON-safe rendering of a :class:`~ai_forge_cli.utils.topics.TopicReport`."""
    return {
