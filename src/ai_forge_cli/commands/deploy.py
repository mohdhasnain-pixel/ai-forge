...
if TYPE_CHECKING:
    from ai_forge_cli.utils.deploy_autopilot import DeployProfile
...
Generated with [Soup CLI](https://github.com/mohdhasnain-pixel/ai-forge) — model: `{MODEL_REPO}`
"""
...
def hf_space(
    ...
    try:
        if template_dir is not None:
            from ai_forge_cli.utils.hf_space import (
                detect_space_sdk,
...
def _auto_detect_template() -> Optional[str]:
    ...
    from ai_forge_cli.utils.ollama import infer_chat_template
