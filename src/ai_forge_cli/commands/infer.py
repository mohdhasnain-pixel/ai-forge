...
def _build_asr_transcriber(
    ...
    """
    from ai_forge_cli.trainer.asr import _require_whisper_base, read_asr_sidecar
...
def _infer_asr(
    *,
    ...
    from ai_forge_cli.utils.asr_metrics import cer, corpus_wer, wer
    from ai_forge_cli.utils.paths import (
        atomic_write_text,
