...
from ai_forge_cli.utils.constants import GITHUB_URL
...
def _get_mlx_info() -> dict:
    ...
    try:
        from ai_forge_cli.utils.mlx import get_mlx_info
    except ImportError:
...
def _run_nccl_check():
    ...
    try:
        ...
        from ai_forge_cli.utils.profiling_v0_43 import nccl_bandwidth_check
