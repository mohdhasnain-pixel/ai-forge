...
def benchmark(
    ...
    try:
        ...
        console.print(
            ...
            "Install with: [bold]pip install \"ai-forge\\[eval]\"[/]"
        )
        raise typer.Exit(1)
...
def custom(
    ...
    from ai_forge_cli.eval.custom import load_eval_tasks
    ...
    results_list = []
    from ai_forge_cli.eval.custom import _create_default_generator, score_task
    ...
    from ai_forge_cli.eval.custom import EvalResults
    ...
    if output or attach_to_registry:
        from ai_forge_cli.registry.attach import attach_artifact, write_eval_json
...
def judge(
    ...
    from ai_forge_cli.eval.judge import JudgeResults
...
def compare(
    ...
    from ai_forge_cli.eval.leaderboard import compare_runs
    from ai_forge_cli.experiment.tracker import ExperimentTracker
...
def human(
    ...
    from ai_forge_cli.eval.custom import _create_default_generator
...
def gate_cmd(
    ...
    from ai_forge_cli.eval.gate import load_suite, resolve_baseline, run_gate
...
from ai_forge_cli.commands._eval_v0550 import register as _register_v0550  # noqa: E402

_register_v0550(app, console)

# Register v0.61.0 subcommands (eval unlearning)
from ai_forge_cli.commands._eval_v0610 import register as _register_v0610  # noqa: E402

_register_v0610(app, console)

# Register v0.65.0 subcommands (eval behavior / capability / checklist / irt-subset)
from ai_forge_cli.commands._eval_v0650 import register as _register_v0650  # noqa: E402

_register_v0650(app, console)

# Register v0.71.10 subcommand (eval citation — #202)
from ai_forge_cli.commands._eval_v07110 import register as _register_v07110  # noqa: E402
