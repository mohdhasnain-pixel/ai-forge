...
helpers from ``ai_forge_cli/utils/data_score.py``, and writes an enriched
...
def _write_rows(rows: Iterable[Mapping[str, Any]], path: str) -> str:
    from ai_forge_cli.utils.data_score import write_jsonl_rows
...
def score(
    ...
    from ai_forge_cli.utils.data_score import BENCHMARKS, compute_scorecard
...
def decontaminate(
    ...
    """
    from ai_forge_cli.utils.data_score import (
        BENCHMARKS,
        decontaminate_rows,
        extract_row_text,
        load_jsonl_rows,
...
def toxicity(
    ...
    from ai_forge_cli.utils.data_score import extract_row_text, score_toxicity
...
def langdetect(
    ...
    from ai_forge_cli.utils.data_score import detect_language, extract_row_text
...
def pii(
    ...
    from ai_forge_cli.utils.data_score import detect_pii, extract_row_text
...
def educational(
    ...
    from ai_forge_cli.utils.data_score import extract_row_text, score_educational_value
