...
from ai_forge_cli.utils.run_cost import format_cost_usd
...
def replay(
    ...
    from ai_forge_cli.experiment.tracker import ExperimentTracker
    from ai_forge_cli.utils.replay import downsample, summarise
...
def curriculum_curve(
    ...
    from ai_forge_cli.experiment.tracker import ExperimentTracker
    from ai_forge_cli.utils.curriculum_dynamic import parse_history_jsonl, render_curve
    from ai_forge_cli.utils.paths import is_under_cwd
