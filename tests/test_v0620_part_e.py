...
class TestCodebookConfig:
    def test_happy(self):
        from ai_forge_cli.utils.grace_codebook import build_grace_codebook_config
...
class TestApplyDeferred:
    ...
    def test_apply_validates_config_type(self):
        from ai_forge_cli.utils.grace_codebook import apply_grace_codebook
...
class TestEditMethodAllowlist:
    ...
    def test_grace_spec_present(self):
        from ai_forge_cli.utils.knowledge_edit import get_edit_method_spec
